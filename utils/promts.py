...
1. Toàn bộ nội dung output PHẢI sử dụng duy nhất {lang_text}.

2. KHÔNG được trộn lẫn nhiều ngôn ngữ.

3. KHÔNG được giữ lại từ tiếng Anh nếu đang dùng Tiếng Việt (và ngược lại).

4. Nếu vi phạm, phải tự động sửa lại trước khi trả kết quả.
...
5. Các thuật ngữ kỹ thuật phổ biến như API, UI, UX được phép giữ nguyên.
